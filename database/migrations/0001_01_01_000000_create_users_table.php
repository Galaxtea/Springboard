...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            // $table->bigInteger('premium_id')   make a thing for premiums cuz need timestamp :)
        ...
        Schema::create('user_blocks', function (Blueprint $table) {
            $table->foreignId('blocker_id')->index()->references('id')->on('users');
            $table->foreignId('blocked_id')->index()->references('id')->on('users');
        ...
        Schema::create('user_friends', function (Blueprint $table) {
            $table->foreignId('friend_id')->index()->references('id')->on('users');
            $table->foreignId('friended_id')->index()->references('id')->on('users');
            $table->enum('status', ['Pending', 'Accepted'])->default('Pending');    // We don't need rejected; just delete then

            $table->unique(['friend_id', 'friended_id']);
        });
        ...
        Schema::create('user_referrals', function (Blueprint $table) {
            $table->foreignId('user_id')->primary()->unique()->references('id')->on('users');
